/* 
    ...
    ---
        Already we know the Working Directory is our Project Managed by Git... If you create the new Git Project with all your files and multiple commits, then all these commits will be stored in so called "Master Branch". You can think of the Master Branch as a folder inside your Git Project and the folder holds all the different versions of your project that you had i.e
            ...1st commit
            ...2nd commit
            ...3rd commit 

            NOTE:
                You can always jump back to previous versions therefore you have an entire history. We could now say this is the finished FIRST version of your website and inside the master branch is the core folder that contain the running version of the website that you currently have...
                ...
                Lets say you want to implement a new feature into your website i.e.
                    ...
                    i.e Live Version of your website might BREAK your website if you accidentally introduce BUGS and this is not what you would want...
                    ...
                    With branches we can create completely new working directory which is an entire copy of the current stage of your master branch but this branch is NOT called master branch but you can give it a different name. 
                        eg. Landing Page Branch
                            ...
                            The big advantage is you and other developers can work independently from each other on dedicated features and finally MERGE the work together to the actual running website...
