    ...
    i.e
        ...
        NOTE:
            If you create this Project on your Computer, this has nothing to do with GIT, 
                i.e a plain folder without any Version Management Enhancement
            ...
            WORKING DIRECTORY
                ...
                Let's say you did an update on "styles.css",
                    ...
                    IMPORTANT:
                        The 'CORE LOGIC' in Git is to TURN a "PROJECT FOLDER" into a "WORKING DIRECTORY" which means files would be managed by Git and we are now able to create different Commits (snapshots) to track all changes made throughout different stages the project goes through.
