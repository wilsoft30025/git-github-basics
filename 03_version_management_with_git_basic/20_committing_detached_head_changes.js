/* 
    ...
    ---
        Detached HEAD normally happens when you directly Checkout Commit. Refer the explanation at 
            note 12_detached_head.js
            ...
            After you commit, when you open your branch list using the "git branch", you will see something like
                ...
                *(HEAD detached at e54647474)
                 ...
                 ------
                    ...
                    Now assuming we add more files and updates to our detached HEAD and add to staging area and finally commit it again, out latest commit will still be our HEAD
