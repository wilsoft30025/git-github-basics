              ...
              * main
              ...
              -------------------
                ...
                Let's see this from a theoretical perspective; 
                    ...
                    Local Branch ---> main
                    ----------------------
                        when we run the command "git push -u origin main", what happened behind the scenes is that git created
                            ----------------------------------------------
                            Remote Tracking branch ---> remote/origin/main
                            ----------------------------------------------
                                ...that was the red branch we saw when we executed the command "git branch -a". 

                                NOTE: 
                                    The REMOTE TRACKING BRANCH is basically BETWEEN our LOCAL and REMOTE branches.

                                    It can be termed as a LOCAL COPY of the Remote Branch 
                                        i.e local copy of our master branch is copied into the remote master tracking branch
                                ...
                                So the Flow is if you run "git push origin main", understand that there is no DIRECT CONNECTION between our LOCAL and REMOTE branches, ANY KIND OF push and pull operations always involve a "Remote Tracking Branch". 
                                
                                And this "Remote Tracking Branch" is a Local Copy of the remote branch.
